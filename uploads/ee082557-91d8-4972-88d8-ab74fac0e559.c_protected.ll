; ModuleID = '/app/uploads/ee082557-91d8-4972-88d8-ab74fac0e559.c'
source_filename = "/app/uploads/ee082557-91d8-4972-88d8-ab74fac0e559.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@__const.secret_logic.secret = private unnamed_addr global [31 x i8] c"\60\5c\5d\47\14\5d\47\14\55\14\42\51\46\4d\14\47\51\57\46\51\40\14\59\51\47\47\55\53\51\15\34", align 1
@.str = private unnamed_addr global [14 x i8] c"\bb\8b\98\97\9a\91\d9\b8\c3\d9\dc\9d\f3\f9", align 1
@.str.1 = private unnamed_addr global [14 x i8] c"\15\25\36\39\34\3f\77\15\6d\77\72\33\5d\57", align 1
@.str.2 = private unnamed_addr global [18 x i8] c"\64\4b\4c\43\4e\02\50\47\51\57\4e\56\18\02\07\46\28\22", align 1
@.str.3 = private unnamed_addr global [12 x i8] c"\91\a7\a1\b0\a7\b6\f8\e2\e7\b1\c8\c2", align 1
@.str.4 = private unnamed_addr global [26 x i8] c"\11\36\23\30\36\2b\2c\25\62\21\2d\2f\32\2e\27\3a\62\36\27\31\36\6c\6c\6c\48\42", align 1
...
define dso_local void @secret_logic(i32 noundef %r0, i32 noundef %r1) #0 {
  ...
  store i32 520470, ptr %v_state, align 4
  br label %v_dispatcher

v_dispatcher:
  %curr_v_state = load i32, ptr %v_state, align 4
  switch i32 %curr_v_state, label %v_default_dest [
    i32 520470, label %v_block_entry
    i32 637814, label %v_block_r11
    i32 164138, label %v_block_r18
    i32 929071, label %v_block_r25
    i32 537670, label %v_block_r26
    i32 312707, label %v_block_r29
    i32 516579, label %v_block_r33
    i32 179947, label %v_block_r36
  ]
...
v_block_entry:
  ...
  %next_v_state_entry = select i1 %r10, i32 637814, i32 164138
...
v_block_r11:
  ...
  store i32 929071, ptr %v_state, align 4
  br label %v_dispatcher
...
v_block_r25:
  ...
  store i32 537670, ptr %v_state, align 4
  br label %v_dispatcher

v_block_r26:
  %r27 = load i32, ptr %r7, align 4
  %r28 = icmp slt i32 %r27, 5
  %next_v_state_r26 = select i1 %r28, i32 312707, i32 179947
...
v_block_r29:
  ...
  store i32 516579, ptr %v_state, align 4
  br label %v_dispatcher
...
entry:
  call void @decrypt_data(ptr @__const.secret_logic.secret, i64 31, i8 52)
  call void @decrypt_data(ptr @.str, i64 14, i8 249)
  call void @decrypt_data(ptr @.str.1, i64 14, i8 87)
  call void @decrypt_data(ptr @.str.2, i64 18, i8 34)
  call void @decrypt_data(ptr @.str.3, i64 12, i8 194)
  call void @decrypt_data(ptr @.str.4, i64 26, i8 66)
  ret void
}
