...
@__const.secret_logic.secret = private unnamed_addr constant [31 x i8] c"This is a very secret message!\00", align 1
...
define dso_local void @secret_logic(i32 noundef %0, i32 noundef %1) #0 {
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %5, ptr align 1 @__const.secret_logic.secret, i64 31, i1 false)
